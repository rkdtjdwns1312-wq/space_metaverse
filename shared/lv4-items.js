...
export const LV4_ITEMS = Object.freeze([
  ...
  card('supercluster-card', '초은하단',
    ...
    '보유 중 7일마다 1스택을 모아요. 보유효과 사용에서 1스택으로 별 파편 4개 또는 2스택으로 별 카드 1장을 받아요. 보유효과로는 초은하단 카드가 사라지지 않아요. 여러 장을 보유해도 학생별로 주 1스택을 모아요.',
    '✨', 102, 46,
    {automatic: Object.freeze(['아이템 사용: 초은하단 1개를 소모하고 원하는 금별 카드 2장 지급', '보유효과 사용: 1스택→별 파편4개 또는 2스택→별 카드1장, 보유 카드는 유지']), manual: Object.freeze([])}),

  card('alien-queen-card', '에일리언 퀸',
    '일기 쓰기와 독서 기록 쓰기를 완전히 면제받습니다.',
    '카드를 보유한 채 일기나 독서 기록을 작성할 때마다 별 파편 1개를 받습니다. 면제와 작성 확인은 현실 교실에서 선생님이 관리하며, 별 파편 지급은 선생님 확인 뒤 자동 처리해요. 조합으로 만들 수 있으며 재료 가격이 미정이라 상점 구매·되팔기는 준비 중이에요.',
    '👑', null, null,

...
export const SHOP = Object.freeze({ currency: 'starShards', sellRate: 0.5, maxStack: 99, maxKinds: 40, items: [
  ...
  {id:'moon-rabbit-card',name:'달토끼',description:'즉시 무작위 뽑기 카드 1장의 보상을 받습니다. 선생님의 확인 처리는 필요하지 않아요.',special:'하루에 2장을 사용할 수 없어요. 54장 구성의 카드 더미에서 무작위로 한 장을 뽑아 아이템·별 파편·경험치 보상을 받아요. 우주 먼지는 보상이 없어요.',art:'/assets/items/moon-rabbit-pastel.webp',icon:'🐇',type:'tool',level:1,price:3,targets:'self',secret:false,mode:'draw',effect:{label:'뽑기 카드',icon:'🐇',durationMs:0,style:'card'}},
  ...LV2_ITEMS,
  ...LV3_ITEMS,
  ...LV4_ITEMS,
  ...GOLD_CARD_ITEMS,

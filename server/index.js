...
const game=createClassroomServer({teacherKey:process.env.TEACHER_KEY,publicOrigin:process.env.PUBLIC_ORIGIN,dataDir:process.env.DATA_DIR||'data/classes',studentHours:studentHoursFromEnv()});
